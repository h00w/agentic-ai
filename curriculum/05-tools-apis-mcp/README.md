# Module 05: Tools, APIs and MCP

**Learning objective:** Design and integrate tools without granting unrestricted capability.
...
- Tool schemas
- REST APIs
- Web search and calculators
- Database and filesystem boundaries
...
1. **Function calling.** Connect the concept to a runnable or reviewable artifact.
2. **Tool schemas.** Connect the concept to a runnable or reviewable artifact.
3. **REST APIs.** Connect the concept to a runnable or reviewable artifact.
4. **Web search and calculators.** Connect the concept to a runnable or reviewable artifact.
5. **Database and filesystem boundaries.** Connect the concept to a runnable or reviewable artifact.
6. **Authentication and permissions.** Connect the concept to a runnable or reviewable artifact.
7. **MCP concepts.** Connect the concept to a runnable or reviewable artifact.
8. **Tool discovery.** Connect the concept to a runnable or reviewable artifact.
9. **Tool boundaries and approvals.** Connect the concept to a runnable or reviewable artifact.
