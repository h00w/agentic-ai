...
**Learning objective:** Create reproducible evidence that an agent is reliable rather than merely impressive.
...
1. **Evaluation design.** Connect the concept to a runnable or reviewable artifact.
2. **Golden datasets.** Connect the concept to a runnable or reviewable artifact.
3. **Unit/integration/regression tests.** Connect the concept to a runnable or reviewable artifact.
4. **Task success.** Connect the concept to a runnable or reviewable artifact.
5. **Factuality and groundedness.** Connect the concept to a runnable or reviewable artifact.
6. **Tool correctness.** Connect the concept to a runnable or reviewable artifact.
7. **Trajectory evaluation.** Connect the concept to a runnable or reviewable artifact.
8. **Latency and cost.** Connect the concept to a runnable or reviewable artifact.
9. **Robustness.** Connect the concept to a runnable or reviewable artifact.
10. **Safety and hallucination measurement.** Connect the concept to a runnable or reviewable artifact.
11. **Human evaluation.** Connect the concept to a runnable or reviewable artifact.
