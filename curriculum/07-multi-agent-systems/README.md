...
**Learning objective:** Use multiple agents only when specialization, delegation or parallelism creates measurable value.
...
1. **When not to use multi-agent.** Connect the concept to a runnable or reviewable artifact.
2. **Specialized roles.** Connect the concept to a runnable or reviewable artifact.
3. **Manager/worker.** Connect the concept to a runnable or reviewable artifact.
4. **Hierarchical and peer-to-peer patterns.** Connect the concept to a runnable or reviewable artifact.
5. **Supervisor architecture.** Connect the concept to a runnable or reviewable artifact.
6. **Delegation.** Connect the concept to a runnable or reviewable artifact.
7. **Communication and shared state.** Connect the concept to a runnable or reviewable artifact.
8. **Conflict resolution.** Connect the concept to a runnable or reviewable artifact.
9. **Consensus.** Connect the concept to a runnable or reviewable artifact.
10. **Task routing.** Connect the concept to a runnable or reviewable artifact.
11. **LangGraph, CrewAI and Microsoft ecosystem mappings.** Connect the concept to a runnable or reviewable artifact.
