# Module 03: LLM and Agent Foundations

**Learning objective:** Explain model behavior and design prompts, structured outputs, plans and verification strategies for agent control.
...
- System/user/developer instructions
- Structured outputs
- Prompt engineering
...
1. **LLM fundamentals, tokens and context windows.** Connect the concept to a runnable or reviewable artifact.
2. **Temperature and model selection.** Connect the concept to a runnable or reviewable artifact.
3. **System/user/developer instructions.** Connect the concept to a runnable or reviewable artifact.
4. **Structured outputs.** Connect the concept to a runnable or reviewable artifact.
5. **Prompt engineering.** Connect the concept to a runnable or reviewable artifact.
6. **Task decomposition.** Connect the concept to a runnable or reviewable artifact.
7. **Planning and reflection.** Connect the concept to a runnable or reviewable artifact.
8. **Verification.** Connect the concept to a runnable or reviewable artifact.
9. **Conceptual CoT, ToT and search-based reasoning patterns without exposing hidden chain-of-thought.** Connect the concept to a runnable or reviewable artifact.
...
**First Autonomous Research Agent**
