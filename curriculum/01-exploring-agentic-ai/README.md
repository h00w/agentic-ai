# Module 01: Exploring Agentic AI

**Learning objective:** Evaluate how agentic AI capabilities and constraints shape organizational value creation and adoption decisions.
...
- What is Agentic AI?
- Generative AI vs assistants vs workflows vs agents
- Agent autonomy and goal-oriented systems
- Agent loops: plan, reason, act, observe, learn
- Tool use and memory
...
1. **What is Agentic AI?.** Connect the concept to a runnable or reviewable artifact.
2. **Generative AI vs assistants vs workflows vs agents.** Connect the concept to a runnable or reviewable artifact.
3. **Agent autonomy and goal-oriented systems.** Connect the concept to a runnable or reviewable artifact.
4. **Agent loops: plan, reason, act, observe, learn.** Connect the concept to a runnable or reviewable artifact.
5. **Tool use and memory.** Connect the concept to a runnable or reviewable artifact.
6. **Feedback and stopping conditions.** Connect the concept to a runnable or reviewable artifact.
7. **Failure modes.** Connect the concept to a runnable or reviewable artifact.
8. **Organizational value.** Connect the concept to a runnable or reviewable artifact.
9. **Opportunity assessment.** Connect the concept to a runnable or reviewable artifact.
...
**Should an enterprise automate customer support with an AI agent?**
