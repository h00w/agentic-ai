# Module 09: Security and Safety

**Learning objective:** Apply defense in depth to agent identity, tools, data, execution, and decisions.
...
1. **Prompt injection and indirect injection.** Connect the concept to a runnable or reviewable artifact.
2. **Tool abuse and excessive agency.** Connect the concept to a runnable or reviewable artifact.
3. **Privilege escalation.** Connect the concept to a runnable or reviewable artifact.
4. **Data leakage and secret exposure.** Connect the concept to a runnable or reviewable artifact.
5. **Malicious tool outputs.** Connect the concept to a runnable or reviewable artifact.
6. **Unsafe code execution.** Connect the concept to a runnable or reviewable artifact.
7. **Sandboxing.** Connect the concept to a runnable or reviewable artifact.
8. **Least privilege.** Connect the concept to a runnable or reviewable artifact.
9. **Authentication and authorization.** Connect the concept to a runnable or reviewable artifact.
10. **Policy enforcement.** Connect the concept to a runnable or reviewable artifact.
11. **Human approval.** Connect the concept to a runnable or reviewable artifact.
12. **Rate/token/action limits.** Connect the concept to a runnable or reviewable artifact.
13. **Isolation and network controls.** Connect the concept to a runnable or reviewable artifact.
